 ...
 */
package cn.stylefeng.star.config.datasource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "star.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2, proxyTargetClass = true)
@MapperScan(basePackages = {"cn.stylefeng.star.modular.*.mapper", "cn.stylefeng.star.multi.mapper"})
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "star.muti-datasource")
    ...
    public DynamicDataSource mutiDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties) {
        ...
        DruidDataSource dataSourceStar = dataSource(druidProperties);
        ...
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[0], dataSourceStar);
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[1], bizDataSource);
        dynamicDataSource.setTargetDataSources(hashMap);
        dynamicDataSource.setDefaultTargetDataSource(dataSourceStar);
