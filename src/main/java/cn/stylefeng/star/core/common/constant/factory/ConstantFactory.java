 ...
 */
package cn.stylefeng.star.core.common.constant.factory;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.util.StrUtil;
import cn.stylefeng.star.core.common.constant.cache.Cache;
import cn.stylefeng.star.core.common.constant.cache.CacheKey;
import cn.stylefeng.star.core.common.constant.state.*;
...
import cn.stylefeng.star.modular.system.entity.*;
import cn.stylefeng.star.modular.system.mapper.*;
...
public class ConstantFactory implements IConstantFactory {
    ...
    private TInfosMapper infosMapper = SpringContextHolder.getBean(TInfosMapper.class);
    ...
    @Override
    public String getInfoStatus(String INFO_STATUS) {
        return InfosStatus.getDescription(INFO_STATUS);
    }


    @Override
    public String getNewStatus(String newStatus) {
        return NewsEnum.NewsStatus.getDescription(newStatus);
    }

    @Override
    public String getNewType(String type) {
        return NewsEnum.NewsType.getDescription(type);
    }

    @Override
    public String getUserStatus(String userStatus) {
        return  UserEnum.UserStatus.getDescription(userStatus);
    }
    ...
    @Override
    public String getCreativeStatus(String status) {
        return CreativeEnum.CreativeStatus.getDescription(status);
    }

    @Override
    public String getCreativeType(String type) {
        return UserEnum.UserType.getDescription(type);
    }
