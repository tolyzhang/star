...
import cn.stylefeng.star.modular.system.entity.Dict;
...
public interface IConstantFactory {
    ...
    String  getInfoStatus(String infoStatus);


    String  getNewStatus(String  newStatus);

    String  getNewType(String  type);

    String getUserStatus(String userStatus);

    String  getUserType(String type);

    String  getCreativeStatus(String status);
