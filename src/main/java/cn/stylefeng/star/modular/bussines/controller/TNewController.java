...
public class TNewController extends BaseController {
    ...
    private static String PREFIX = "/modular/bussines/newstr/";
     ...
     */
    @RequestMapping("/newstr_add")
    public String newAdd() {
        return PREFIX + "newstr_add.html";
    }
    ...
    public String newUpdate(@RequestParam Integer id) {
        ...
        return PREFIX + "newstr_edit.html";
    }
